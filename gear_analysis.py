...
cost = geagears_1rs.interaction_cost("7880K26", "6832K58")
...
safety_factor_bending = gears_2.safety_factor_bending("7880K37", "6832K66",bending_stress)

contact_stress = gears_2.contact_stress("7880K37", "6832K58", None, None, 2)
